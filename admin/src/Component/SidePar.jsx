...
function SidePar() {
  ...
  return (
    ...
    {/* Sidebar */}
    <div className=" left-0 flex h-screen w-72 flex-col overflow-hidden rounded-r-2xl bg-[#c65f20] text-white">
      ...
      <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
        ...
        <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 font-semibold hover:bg-slate-600">
          ...
          <Link to="events">
          <span className="">Events</span></Link>
          <svg
        ...
        <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
          ...
          <Link to="tickets">
          <span className="">Tickets</span></Link>
        </li>
        <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
          ...
          <Link to ="message">
          <span className="">Massage</span></Link>
        </li>
        {/* <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">
          <span>
            <svg
